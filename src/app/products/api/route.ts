...
export const products: Product[] = [
  {
    ...
    title: "Megatron",
    description:
      "Leader of the decepticons. Megatron is a Decepticon, one of the lineal descendants of the military hardware robots created by the Quintessons on their factory world of Cybertron.",
    price: 50.0,
    photo: "/megatron.jpeg",
